...
def main():
    ...
    response  = query_engine.query("I would like to write a short but engaging blog post of 300 words on the following topic : What's happening with all those who say we should be terribly afraid of AI ?")
    print(response)
